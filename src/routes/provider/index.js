		...
		if(this.props.get_contact!=null && this.props.get_contact.length>0) {
			...
			this.props.get_contact.map((ro)=>{
				...
				data.push(
					[
						<div className="media" >
						{ro.profilePic ? <img src={ro.profilePic} alt="user prof" class="rounded-circle mr-15" width="50" height="50"></img>:<img src="https://cdn1.iconfinder.com/data/icons/user-pictures/100/unknown-512.png" alt="user prof" class="rounded-circle mr-15" width="50" height="50"></img>}</div>,
