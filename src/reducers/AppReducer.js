 ...
 */
import {
    PATIENT_REFEREL,GET_CONTACT,GET_VIDEOS,GET_SERVEYS,ADD_CONTACT,ADD_VIDEOS,ADD_SERVEY,UPDATE_SERVEY,DELETE_SURVEY,GET_NOTIFICATION,GET_PAGES,GET_PROFILE,GET_DOSE,EMAIL_CHECK
} from 'Actions/types';
